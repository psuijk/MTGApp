...
namespace SampleApp
{
    public class TwoPlayerPage : ContentPage
    {
        ...
        private void StartGame(string name1, string name2)
        {
            ...
            //player2
            GridForP2LifeTotal.Children.Add(p2LifeLabel, 0, 1);

            //
            var GridForP1NameLabel = new Grid()
            {
                HorizontalOptions = LayoutOptions.FillAndExpand,
                VerticalOptions = LayoutOptions.FillAndExpand
            };

            var GridForP2NameLabel = new Grid()
            {
                HorizontalOptions = LayoutOptions.FillAndExpand,
                VerticalOptions = LayoutOptions.FillAndExpand
            };
            ...
            GridForP1NameLabel.Children.Add(nameLabel, 0, 0);

            //player2
            GridForP2NameLabel.Children.Add(nameLabe2, 0, 1);
